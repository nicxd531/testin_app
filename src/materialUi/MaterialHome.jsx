  ...
  return (
    <main className=' material-ui background  pb-3'>
      <header className='mb-2 px-3 header-top-padding'>
        <Typography sx={{ fontSize: { xs: "1.5rem", lg: "2rem" }, fontWeight: "bold" }}>HOME OF MATERIAL UI</Typography>
        <Typography sx={{ fontSize: { xs: "1rem", lg: "1.2rem" } }}>This section contains material ui examples in the creation of google keep</Typography>
        <hr className='w-100 bg-warning mt-5' />
        <Stack direction="row" spacing={2} sx={{ display: "flex" }}>
          <Typography sx={{ textAlign: { xs: "start" }, fontSize: { xs: "1rem", lg: "2rem" } }} variant="h5" >click these buttons for examples and documentations</Typography>
