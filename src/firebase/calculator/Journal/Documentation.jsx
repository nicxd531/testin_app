...
function Documentation({setStrategyName,setExplantionEntry}) {
    ...
    <Box>
        ...
        <Box>
            <FormGroup sx={{mt:3,flexDirection:{"xs":"column","lg":"column"}}} className='d-flex justify-content-satrt align-items-start '>
                <TextField  sx={{mr:{"lg":3},mt:{"xs":3},width:{"xs":"80%","lg":"20%"}}} id="outlined-basic" label="Startegy Name" variant="outlined" onChange={(e)=>setStrategyName(e.target.value)}/>
                <TextField
