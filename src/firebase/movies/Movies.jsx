...
useEffect(()=>{
  ...
  return (
    <Box className="movies  d-flex justify-content-center align-items-center" sx={{maxWidth:{xs:"400px",lg:"1800px"},flexGrow: 1,py:5 ,position:"relative",height:"fit-content"}}>
