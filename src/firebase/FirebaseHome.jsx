...
function FirebaseHome() {
  const header ="HOME OF FIREBASE"
  const description ="This section contains integration of firebase as a backend storage and authenticator for the movies and expense tracker app"
