...
const theme = useTheme();
  return (
    <Drawer id="drawerM2" className='drawer' variant="permanent" open={open} sx={{position:"relative",overflow:"visible",height:"100%",}}>
                    ...
                    <ListItem key={text.iconName} disablePadding sx={{ display: 'block' }}>
                         <Link to={text.iconLink}>
                            ...
                            >
                                    ...
                                    >
                                    {index % 2 === 0 ? <AccountBalanceIcon /> : <MovieIcon/>}
                                    </ListItemIcon>
