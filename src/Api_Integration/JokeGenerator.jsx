  ...
  return (
    <section className='d-flex justify-content-center align-items-center w-100 mt-5  '>
      <Box sx={{bgcolor:"#cfccd5"}} className="p-5 br-5 d-flex justify-content-center align-items-center flex-column">
        <Typography variant="h4" sx={{textTransform:"capitalize",textAlign:"center",fontWeight:"bold",mb:2}}> welcome to joke generator</Typography>
        <Divider className='bg-info'/>
        <Typography variant='h5' sx={{mb:2,textAlign:"justify"}}>{jokeData? jokeData : "click the button below to generate a joke"} </Typography>
